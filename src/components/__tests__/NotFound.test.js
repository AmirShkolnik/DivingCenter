...
describe('NotFound', () => {
  test('renders without crashing', () => {
    ...
    expect(screen.getByText(/Our apologies, this page must have gotten eaten by a shark!/i)).toBeInTheDocument();
  });
  ...
  test('displays the correct image and text', () => {
    ...
    expect(imgElement).toHaveAttribute('src', expect.stringContaining('no-results.webp'));
